...
Func Example()
	...
	Global $hGUI = GUICreate("Mouse Hareket ve Konum Yakalama Denemeleri", 800, 600)
...
Func _Draw()
	...
	_GDIPlus_GraphicsDrawStringEx($hGfx_Buffer, "Earth Telekom!", $hFont, $tLayout, $hFormat, $hBrush)
	...
	_GDIPlus_GraphicsDrawStringEx($hGraphics, "Sol Tıklayarak Göreli Yakala", $hFont, $tLayout, $hFormat, $hBrush)

	DllStructSetData($tLayout, "Y", 30)
	_GDIPlus_GraphicsDrawStringEx($hGraphics, "Mouse Orta Tuş İle Zoom Olayları", $hFont, $tLayout, $hFormat, $hBrush)

	DllStructSetData($tLayout, "Y", 50)
	_GDIPlus_GraphicsDrawStringEx($hGraphics, "Sol tıklayarak orta tuş ile görseli döndür", $hFont, $tLayout, $hFormat, $hBrush)

	DllStructSetData($tLayout, "Y", 70)
	_GDIPlus_GraphicsDrawStringEx($hGraphics, "Sağ tıklayarak görsel konumunu sıfırla", $hFont, $tLayout, $hFormat, $hBrush)
	...
	_GDIPlus_GraphicsDrawStringEx($hGraphics, "Görsel Konum Değerleri:", $hFont, $tLayout, $hFormat, $hBrush)
